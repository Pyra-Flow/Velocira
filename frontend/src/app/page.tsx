...
import { ArrowRight, FileText, FolderKanban, Sparkles, WandSparkles } from "lucide-react";
      ...
      <section className="public-page">
        <section className="public-hero public-hero--visual">
          <div className="public-hero__content">
            <p className="public-eyebrow"><WandSparkles className="h-4 w-4" /> Velocira by PyraFlow</p>
            <h1>From a product idea to a complete documentation package.</h1>
          ...
          <SignalForgeVisual name="hero" priority label="Documentation signal map" />
        </section>
